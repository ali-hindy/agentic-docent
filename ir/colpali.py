...
def main():
    ...
    database_embeddings = get_image_embeddings(model, processor, database_images, device=device)
    
    print("Processing query images...")
    query_embeddings = get_image_embeddings(model, processor, query_images, device=device)
